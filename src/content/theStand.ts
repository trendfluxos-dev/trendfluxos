...
// This is a historical record; intentionally version-controlled (no admin UI).

export type IconicQuote = {
  bn: string;
  en?: string;
  context?: string;
};
...
export const THE_STAND = {
    ...
    pillars: [
      {
        ...
        body: "দুর্নীতিগ্রস্ত কাঠামোর ভেতরে থেকেও মায়ের শেখানো সততাকে সর্বোচ্চ অগ্রাধিকার — প্রতিষ্ঠানিক সুশাসন না থাকলেও পারিবারিক সুশিক্ষাই যে একজনকে সঠিক পথে রাখে, তার প্রমাণ।",
      },
      {
        title: "ক্ষমতার সুরভেদ অস্বীকার",
        body: "দলের সভাপতির মুখোমুখি দাঁড়িয়ে পারিবারিক সততার আদর্শকে বড় করে তোলা — ছাত্র রাজনীতির অলিখিত হ্যারার্কির বিরুদ্ধে অভাবনীয় সাহস।",
      },
      {
        title: "অর্থনৈতিক প্রলোভন প্রত্যাখ্যান",
        body: "বিপুল অবৈধ অর্থের প্রবাহ থেকে নিজেকে সরিয়ে রাখা — সততার জন্য অর্থনৈতিক আত্মত্যাগের প্রকৃত দৃষ্টান্ত।",
      },
    ],
  },
  ...
  timeline: {
    ...
    events: <TimelineEvent[]>[
      ...
      },
      {
        ...
        body: "কক্ষের দরজা বন্ধ। আরমান খান যুব ও তিন সহযোগী — আরাফাত, তুষণ ও অজ্ঞাতনামা — অনবরত রড ও হাতুড়ি দিয়ে পেটাতে থাকে। চারজন প্রাপ্তবয়স্কের পরিকল্পিত পাশবিক আক্রমণ একজন নিরস্ত্র শিক্ষার্থীর ওপর।",
      },
      {
        time: "চরম মুহূর্ত",
        title: "আগ্নেয়াস্ত্র — মৃত্যুর মুখোমুখি",
        body: "যুব পোশাকের ভেতর থেকে অবৈধ পিস্তল বের করে ইমনের পেটে ঠেকায়। ইয়াবা সেবন করা অবস্থায় হিতাহিতজ্ঞানশূন্য। ভয়ে কাঁপতে কাঁপতে ইমন বলেছিলেন — পেটে নয়, মাথায় গুলি করুন।",
      },
      {
        time: "চরিত্র হনন",
        title: "জোরপূর্বক মদ ঢালা ও ভিডিও ধারণ",
        body: "শরীরে জোর করে মদ ঢেলে দেওয়া হয় — যাতে গন্ধ বের হয় এবং পরবর্তীতে তাকে মাদকাসক্ত প্রমাণ করা যায়। জোরপূর্বক স্বীকারোক্তির ভিডিও ধারণ করা হয়।",
      },
      {
        time: "পরের দিনগুলো",
  ...
  quotes: <IconicQuote[]>[
    ...
    {
      bn: "চুপ থাকা মানে অন্যায়ের সঙ্গে চুক্তি।",
      context: "হুইসেলব্লোয়িং দর্শন",
    },
    {
    ...
    {
      bn: "ন্যায়ের দাবি তোলা এখনো সম্ভব।",
      context: "ভবিষ্যৎ প্রজন্মের জন্য বার্তা",
    },
  ],

  context2024: {
    title: "জুলাই ২০২৪ — গণঅভ্যুত্থানের প্রেক্ষাপট",
    body: `২০২৩ সালে একা দাঁড়ানো ইমনের প্রতিবাদ পরবর্তী বছরের ছাত্র গণঅভ্যুত্থানের নৈতিক ভিত্তি গড়ে দিয়েছিল। যে কাঠামো