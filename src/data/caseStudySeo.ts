/**
 * Runtime mirror of `scripts/case-study-seo.mjs`.
 *
 * The .mjs file feeds the build-time prerendered <head>; this module feeds
 * the Helmet tags rendered by `/case-studies/:slug`. Both must stay in sync
 * so JS and non-JS crawlers see identical metadata.
 */
