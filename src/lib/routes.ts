...
export const routes = {
  ...
  "/edtech/live/recap/:id": make(() => import("@/pages/edtech/EdtechLiveRecap")),
...
const PAGE_META: Record<string, { label?: string; keywords?: string; type?: PageType }> = {
  ...
  "/news":                     { label: "Newsroom — Nagarik Barta 24", keywords: "news newsroom nagarik barta bangla headlines press feed" },
