                      ...
                      <div key={layer} className="flex flex-col gap-0.5">
                        ...
                        {items.map((node) => (
                          <Link
                            ...
                            className="relative rounded-xl px-3 py-2.5 min-h-10 text-[14.5px] text-[#f0c9c9]/80 hover:text-white hover:bg-[#2a0f14]/60 hover:translate-x-1 transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#e25a5a]/60 aria-[current=page]:text-white aria-[current=page]:bg-[#3a1418]/70 aria-[current=page]:before:absolute aria-[current=page]:before:left-0 aria-[current=page]:before:top-1/2 aria-[current=page]:before:-translate-y-1/2 aria-[current=page]:before:h-5 aria-[current=page]:before:w-[3px] aria-[current=page]:before:rounded-r aria-[current=page]:before:bg-[#e25a5a]"
                          >
                            {node.title}
                          </Link>
                        ))}
